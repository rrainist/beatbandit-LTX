...
export interface MenuDepsParams {
  ...
  openBeatBanditBatchGenerateModal: () => void
  beatBanditProjectMissingShotCount: number
  batchGenerationBusy: boolean
  ...
  return [
    ...
    // Import/export, timeline management, project settings
    {
      ...
      items: [
        ...
        {
          id: 'generate-missing-beatbandit-shots',
          label: 'Generate Missing BeatBandit Shots...',
          action: () => p.openBeatBanditBatchGenerateModal(),
          disabled: p.batchGenerationBusy || p.beatBanditProjectMissingShotCount === 0,
        },
      ],
    },
