...
function getHumanMessage(error: string): string {
  ...
  if (lower.includes('validation error') || lower.includes('literal_error') || lower.includes('input should be')) {
    return 'The generation request had invalid settings. Check the technical details for the rejected field and try again.'
  }
