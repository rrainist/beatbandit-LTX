...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  // BeatBandit project import
  extractBeatBanditPackage: (zipPath: string): Promise<{ manifest: unknown; basePath: string; zipPath: string }> =>
    ipcRenderer.invoke('extract-beatbandit-package', zipPath),
